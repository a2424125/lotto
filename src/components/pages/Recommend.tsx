...
const Recommend: React.FC<RecommendProps> = ({
  ...
  const gradeInfo: { [key: string]: any } = {
    "1": {
      ...
      prize: "약 20억원",
      strategy: `${totalRounds}회차 빅데이터 AI 완벽 분석`, // ✅ 동적으로 변경
      emoji: "👑",
      color: "#059669",
    },
    "2": {
  ...
  const generate1stGradeRecommendations = async () => {
    setLoading(true);
    try {
      console.log(`🧠 ${totalRounds}회차 AI 빅데이터 분석 시작...`);
  ...
  const generateFallbackStrategies = (
    ...
    for (let i = 0; i < 5; i++) {
      ...
      strategies.push({
        ...
        analysisData: {
          dataRange: `최신 ${totalRounds}회차`, // ✅ 동적으로 변경
          method: "기본 분석",
  ...
  const getConfidenceStyle = (
    ...
    if (confidence >= 95)
      return { color: "#059669", emoji: "🔥", text: "초고신뢰" };
    if (confidence >= 90)
    ...
    <div style={{ padding: "12px" }}>
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <div style={{ fontSize: "14px", opacity: 0.9 }}>
              ...
              >
                <span>
                  📊 <strong>{totalRounds}</strong>회차 분석
                </span>
                <span>
      ...
      >
        ...
        <p style={{ fontSize: "14px", color: "#6b7280", margin: "0 0 16px 0" }}>
          {activeGrade === "1"
            ? `🔥 ${totalRounds}회차 빅데이터 AI 분석으로 최강의 1등 번호를 받아보세요!`
              ...
              style={{
                ...
                border:
                  activeGrade === grade
                    ...
                    : "2px solid #e5e7eb",
                backgroundColor:
                  activeGrade === grade ? `${info.color}15` : "white",
                cursor: "pointer",
                transition: "all 0.2s",
                boxShadow:
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      borderRadius: "4px",
                      backgroundColor:
                        activeGrade === grade ? info.color : "#f3f4f6",
      ...
      {loading ? (
        ...
        >
          ...
          <h3
            style={{ color: "#1f2937", margin: "0 0 8px 0", fontSize: "18px" }}
          >
            {activeGrade === "1"
              ? `🧠 AI가 ${totalRounds}회차 빅데이터를 분석중입니다...`
              : `${gradeInfo[activeGrade].name} 맞춤 번호를 생성중입니다...`}
          </h3>

          {activeGrade === "1" && (
            <div
              style={{ fontSize: "14px", color: "#059669", marginTop: "12px" }}
            >
              <div
                style={{
                  margin: "6px 0",
